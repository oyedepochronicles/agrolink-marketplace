...
const AdminPayouts = () => {
  ...
  const act = async (
    ...
    try {
      ...
      toast.success(
        action === "mark_paid" ? "Marked as paid" : `Payout ${action}d`,
      );
    } catch (e) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Payouts"
        description="Approve and process payout requests from farmers and riders."
      />
      <Card className="rounded-2xl p-5 shadow-card">
        {isLoading ? (
          ...
          <EmptyState
            ...
            description="When users request payouts, they will appear here for review."
          />
        ) : (
          <Table>
            <TableHeader>
