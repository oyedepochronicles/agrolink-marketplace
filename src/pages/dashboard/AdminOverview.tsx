  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Monitor verifications, users, sales, and marketplace health."
      />
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Stat
          ...
          label="GMV (30d)"
          value={formatNaira(cards.gmv30d ?? 0)}
        />
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-[2fr_1fr] overflow-y-auto">
        <Card className="rounded-2xl p-5 shadow-card">
          ...
          <ChartContainer
            config={{ revenue: { label: "GMV", color: "hsl(var(--primary))" } }}
            className="mt-4 h-64"
          >
        ...
        <Card className="rounded-2xl p-5 shadow-card">
          ...
          <ChartContainer
            config={{ total: { label: "Users", color: "hsl(var(--accent))" } }}
            className="mt-4 h-64"
          >
