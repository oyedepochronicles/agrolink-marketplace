...
const Affiliate = () => {
  ...
  const initialRole = (params.get("role") === "rider" ? "rider" : "farmer") as
    | "farmer"
    | "rider";
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      await registerAffiliate({
        ...
        address: locationValue.fullAddress,
        farmName: values.farmName || undefined,
        farmAddress: values.farmAddress || locationValue.fullAddress,
        farmLandmark: values.farmLandmark || locationValue.landmark,
      });
      toast.success(
        "Application received! Submit your verification documents to get started.",
      );
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        {step === "personal" ? (
          <>
            ...
            <LocationSelector
              label={role === "farmer" ? "Farm location" : "Dispatch base"}
              addressLabel={role === "farmer" ? "Farm address" : "Operating address"}
              value={locationValue}
          ...
          <>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="farmAddress"
                placeholder="Farm settlement, road, village"
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="farmLandmark"
                placeholder="Near market, school, junction..."
                {...register("farmLandmark")}
              />
            </div>
          </>
        )}
          ...
          <>
            ...
            >
              {submitting ? (
                ...
                t("auth.applyAs", {
                  role: role === "farmer" ? t("auth.farmer") : t("auth.rider"),
                })
              )}
            </Button>
          </>
